...
👉 **Administrators**: See the [Administration Guide](/public/guides/admnistration.html) for the complete onboarding process.
...
- [Administration Guide](/public/guides/admnistration.html) - **For administrators**: Setup, user onboarding, monitoring
...
**Questions?** Open an issue on [GitHub](https://github.com/ideiasfactory/akm/issues) or check the [discussions](https://github.com/ideiasfactory/akm/discussions).
