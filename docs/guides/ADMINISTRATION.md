...
git clone https://github.com/ideiasfactory/akm.git
...
**Need Help?** Contact the development team or check the [GitHub Issues](https://github.com/ideiasfactory/akm/issues).
